...
/**
 * JoystickView by AJ Alves is licensed under a Creative Commons Attribution-ShareAlike 3.0
 * Unported License. Based on a work at github.com and page
 * zerokol.com/2012/03/joystickview-uma-view-customizada-que.html
 */
public class Joystick extends View implements Runnable {
    ...
    protected void initJoystickView() {
        ...
        mainCircle.setColor(getResources().getColor(R.color.colorPrimaryDark));
        mainCircle.setStyle(Paint.Style.FILL_AND_STROKE);
        secondaryCircle = new Paint();
        secondaryCircle.setColor(getResources().getColor(R.color.colorPrimary));
        secondaryCircle.setStyle(Paint.Style.STROKE);
        verticalLine = new Paint();
        verticalLine.setStrokeWidth(10);
        verticalLine.setColor(getResources().getColor(R.color.colorPrimary));
        horizontalLine = new Paint();
        horizontalLine.setStrokeWidth(2);
        horizontalLine.setColor(getResources().getColor(R.color.colorPrimary));
        button = new Paint(Paint.ANTI_ALIAS_FLAG);
        button.setColor(getResources().getColor(R.color.brandPrimary));
